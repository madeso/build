...
internal static class IndentFunctions
{
    ...
    public static FileIndent CollectIndentInformation(Fil f, int tab_width, bool enable_javadoc_hack)
    {
        var lines = f.ReadAllLines().ToImmutableArray();
    ...
    private static IEnumerable<string> FileReadLines(Fil path, bool discard_empty)
    {
    ...
    private static IEnumerable<int> GetAllIndent(Fil path, bool discard_empty)
    {
    ...
    private static int GetMaxIndent(Fil path, bool discard_empty)
    {
