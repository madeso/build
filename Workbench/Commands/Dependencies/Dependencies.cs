...
public static class Dependencies
{
    ...
    internal static async Task WriteToGraphvizAsync(Executor exec, Vfs vfs, Config.Paths paths, Dir cwd, Log log, Dir doxygen_xml, string namespace_name,
        ...
        bool add_members, bool cluster_namespace)
    {
        ...
        await g.SmartWriteFileAsync(exec, vfs, paths, cwd, output_file, log);
    }
