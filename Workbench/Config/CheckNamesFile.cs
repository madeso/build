...
internal class CheckNamesFile
{
    ...
    public static CheckNamesFile? LoadFromDirectoryOrNull(Vfs vfs, Dir cwd, Log print)
    {
        return ConfigFile.LoadOrNull<CheckNamesFile>(vfs, print, GetBuildDataPath(cwd));
    }
}
